...
public class PyxlHighlightingLexer extends PyxlLexer {
    private final LanguageLevel mLanguageLevel;

    public PyxlHighlightingLexer(LanguageLevel languageLevel) {
        super();
    ...
    public IElementType convertStringType(IElementType tokenType, String tokenText) {
        return convertStringType(tokenType, tokenText, mLanguageLevel, hasUnicodeImport);
    }
